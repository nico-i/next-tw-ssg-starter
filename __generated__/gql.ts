...
export type GetSpaceShipsQuery = { __typename?: 'Root', allStarships: { __typename?: 'StarshipsConnection', starships: Array<{ __typename?: 'Starship', name: string | null } | null> | null } | null };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetSpaceShips(variables?: GetSpaceShipsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetSpaceShipsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetSpaceShipsQuery>(GetSpaceShipsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetSpaceShips', 'query', variables);
    }
  };
}
